...
<div id="subheading">
	...
	<a href="" onclick='return fb_login_click()'><img id="main-image" src="images/screen.png" alt="a world map showing all of your friends based on their current location"/></a>
	<div id="fb-bar"><div id="fb-button"><?php echo getLoginButton($ie);?></div><div>connect with facebook to get started</div></div>
</div> 
