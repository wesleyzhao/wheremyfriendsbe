...
if ($user_oauth_id == ''){
	...
	mysqlConnect();
	$res = mysql_query("SELECT name,access_token FROM users WHERE oauth_id='$user_oauth_id'");
...
<div id="heading">
	...
	<script type="text/javascript"> 
		...
		<?php 
				if($has_loaded){
					$friends_count = getFriendCount($user_oauth_id);
				}
				else{
 ...
 <div id="fb-root"></div>
   ...
   <div id="subheading"><?php print $name; ?> has <?php print $friends_count; ?> friends in <span id="places">0</span> places around the world.<br> <?php echo getSignUp();?>   </div>
  <div id="map_canvas"></div>
  <br>
  <center>Map not working? Click <a href="/reload.php?oauth_id=<?php print $user_oauth_id; ?>">here</a> to reload it.</center>
  <?php
